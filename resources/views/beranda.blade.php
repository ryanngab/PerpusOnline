				...
				<ul>
					...
					<li>
						<form action="/logout" method="POST">
							@csrf
							<button type="submit" class="getstarted scrollto btn btn-outline-primary"></i> Logout</button>
						</form>
					</li>
					@endauth
					@guest
				...
				<div class="row">
					<div class="owl-carousel owl-theme">
						<div class="item service-item">
							...
							<p></p>Novel Bulan Masih menceritakan petualangan dari tiga sekawan, pada novel Bulan ini dikisahkan Ali, Seli, dan Raib yang dibawa oleh Miss Selena dan Av untuk melakukan diplomasi di Klan Matahari. Tujuannya adalah untuk membuka portal atau gerbang yang sudah ribuan tahun lamanya ditutup.</p>
